import { applicaTentativo } from '../art161/reati.catalogo.js';
/* ==========================================================================
...
export function getFattispeciePerqL152(){
  ...
  const base = (tipo === "altro")
    ? (document.getElementById("pl152_161_reato")?.value || "").trim()
    : (FATTISPECIE_PERQ_L152[tipo] || "");
  return applicaTentativo(base, document.getElementById("pl152_tentativo")?.checked === true);
}
