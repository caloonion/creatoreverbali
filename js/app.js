...
// AUTOMATISMI LETTERA DI TRASMISSIONE PREFETTURA
function updateTrasmissioneAutoInfo(){
  ...
  const siglaMap = {
    "AGRIGENTO":"ag","ALESSANDRIA":"al","ANCONA":"an","AREZZO":"ar","ASCOLI PICENO":"ap",
    "ASTI":"at","AVELLINO":"av","BARI":"ba","BARLETTA-ANDRIA-TRANI":"bt","BELLUNO":"bl",
    "BENEVENTO":"bn","BERGAMO":"bg","BIELLA":"bi","BOLOGNA":"bo","BRESCIA":"bs",
    "BRINDISI":"br","CAGLIARI":"ca","CALTANISSETTA":"cl","CAMPOBASSO":"cb","CASERTA":"ce",
    "CATANIA":"ct","CATANZARO":"cz","CHIETI":"ch","COMO":"co","COSENZA":"cs",
    "CREMONA":"cr","CROTONE":"kr","CUNEO":"cn","ENNA":"en","FERMO":"fm",
    "FERRARA":"fe","FIRENZE":"fi","FOGGIA":"fg","FORLÌ-CESENA":"fc","FROSINONE":"fr",
    "GENOVA":"ge","GORIZIA":"go","GROSSETO":"gr","IMPERIA":"im","ISERNIA":"is",
    "L'AQUILA":"aq","LA SPEZIA":"sp","LATINA":"lt","LECCE":"le","LECCO":"lc",
    "LIVORNO":"li","LODI":"lo","LUCCA":"lu","MACERATA":"mc","MANTOVA":"mn",
    "MASSA-CARRARA":"ms","MATERA":"mt","MESSINA":"me","MILANO":"mi","MODENA":"mo",
    "MONZA E DELLA BRIANZA":"mb","NAPOLI":"na","NOVARA":"no","NUORO":"nu","ORISTANO":"or",
    ...
    "SIRACUSA":"sr","SONDRIO":"so","TARANTO":"ta","TERAMO":"te","TERNI":"tr",
    "TORINO":"to","TRAPANI":"tp","TREVISO":"tv","TRIESTE":"ts","UDINE":"ud",
    "VARESE":"va","VENEZIA":"ve","VERBANO-CUSIO-OSSOLA":"vb","VERCELLI":"vc","VERONA":"vr",
  ...
  if(prefCittaEl && prefCittaEl.value && prefPecEl && (!prefPecEl.value || prefPecEl.dataset.autofilled === "true")){
    const s = siglaMap[prefCittaEl.value];
    if(s){
  ...
  // Data odierna automatica per la lettera
...
function syncTrasmissioneUI(){
  ...
  if(!on && docAttivo === "trasmissione"){
    setDocAttivo("verbale");
  }
...
// AUTOMATISMI ETICHETTA REPERTO
function updateEtichettaAutoInfo(){
  const autoPratica = document.getElementById("etichetta_auto_pratica")?.checked !== false;
  const praticaEl = document.getElementById("etichetta_n_pratica");
  if(praticaEl){
    praticaEl.readOnly = autoPratica;
    praticaEl.style.background = autoPratica ? "#f3f3f3" : "#fff";
    if(autoPratica){
      const prot = (document.getElementById("trasm_n_prot")?.value || "").trim();
      if(prot) praticaEl.value = prot;
    }
  }
}
