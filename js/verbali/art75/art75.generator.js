...
import { $, normPeso, ensureDotEnd, ensureEndsVerbaleMark, renderHeader, getSoggetto, getFormattedItalianDate } from '../../core/utils.js';
...
export function generaTrasmissioneHTML(){
  ...
  html += `
    <div style="text-align:center; margin:15pt 0;">~ ~ ~ ~ ~</div>
  `;
...
export function generaEtichetta(){
  ...
  return `
    <div style="${f} font-size:9pt; line-height:1.35; width:8cm; border:2px solid #000; padding:2mm 2.5mm; margin: 0 auto;">
      <div style="text-align:center; font-weight:bold; font-size:11pt; border-bottom:1px solid #000; padding-bottom:2mm; margin-bottom:2mm">
        CARABINIERI<br>
