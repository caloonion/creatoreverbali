...
export function generaFermoSeq(getOperantiListFn){
  ...
  html += renderSignatureBlock(
    affidatario === "interessato"
      ? [F ? "L'Interessata" : "L'Interessato", bloccoVerbalizzanti()]
      : ["Il Custode", "Il Conducente/Proprietario", bloccoVerbalizzanti()]
  );
