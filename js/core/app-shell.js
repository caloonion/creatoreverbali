...
import { ETICHETTA_DOCS } from '../verbali/etichetta/etichetta.generator.js';
...
const DOC_FILENAMES = {
  ...
  verbaleP352: "verbale_perquisizione_art352",
  sequestroP352: "verbale_sequestro_art354",
  verbalePL152: "verbale_perquisizione_L152-75",
  sequestroPL152: "verbale_sequestro_art354",
  verbaleSeq354: "verbale_sequestro_art354",
  verbaleSopralluogo: "verbale_sopralluogo_art354",
  verbaleVeicolo: "verbale_restituzione_veicolo",
  verbaleAffidamento: "verbale_affidamento_minore",
  verbaleNotifica: "relata_di_notifica",
  verbaleFermoSeq: "verbale_sequestro_fermo_amministrativo",
  cartelloVeicolo: "cartello_veicolo",
  verbaleSeqVeicolo: "verbale_sequestro_veicolo_sinistro",
  verbaleRimozione: "verbale_rimozione_veicolo",
  verbalePatente223: "verbale_ritiro_patente_art223",
  verbalePatenteIll: "verbale_ritiro_patente_illeggibile",
  verbalePrelievo: "richiesta_accertamenti_urgenti",
  verbaleTulps15: "invito_art15_tulps",
  verbaleInvito650: "invito_art650",
  verbaleCadavere: "verbale_rimozione_cadavere",
  etichettaP352: "etichetta_reperto",
  etichettaPL152: "etichetta_reperto",
  etichettaSeq354: "etichetta_reperto",
  etichettaSopr: "etichetta_reperto",
  trasmissionePatente: "lettera_trasmissione_patente",
  sequestroVeicolo: "verbale_sequestro_art354",
  sequestroSopr: "verbale_sequestro_art354"
};
...
function isEtichettaActive(){
  const doc = document.querySelector(".docTab.active")?.dataset.doc;
  return ETICHETTA_DOCS.includes(doc);
}
