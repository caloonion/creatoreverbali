...
export function generaPrelievo(getOperantiListFn){
  ...
  html += `<p style="text-align:center; font-weight:bold; letter-spacing:2px; margin:8pt 0; ${fontMain}">${conc("C H I E D E", "C H I E D O N O")}</p>`;
  ...
  html += renderSignatureBlock(["Il Medico (timbro e firma)", bloccoVerbalizzanti()]);
